    ...
    public List<Recipe> getRecipes() {
        return Arrays.asList(
                new Recipe(
                        ...
                        Arrays.asList(new Ingredient("Raspberries", Ingredient.QuantityType.CUPS, 3),new Ingredient("Flour", Ingredient.QuantityType.CUPS, 2),new Ingredient("Sugar", Ingredient.QuantityType.CUPS, 1),new Ingredient("Butter", Ingredient.QuantityType.OZ, 2), new Ingredient("Raspberries", Ingredient.QuantityType.CUPS, 3),new Ingredient("Flour", Ingredient.QuantityType.CUPS, 2),new Ingredient("Sugar", Ingredient.QuantityType.CUPS, 1),new Ingredient("Butter", Ingredient.QuantityType.OZ, 2))),
                new Recipe(
                        "Thai Fried Rice",
                        ...
                        Arrays.asList(new Ingredient("raspberries", Ingredient.QuantityType.CUPS, 3))),
                new Recipe(
                        "Spaghetti",
