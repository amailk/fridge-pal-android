    ...
    public List<Recipe> getRecipes() {
        return Arrays.asList(
                ...
                new Recipe(
                        ...
                        ResourcesCompat.getDrawable(resources, R.drawable.friedrice, null)),
                new Recipe(
                        "Spaghetti",
                        ...
                        ResourcesCompat.getDrawable(resources, R.drawable.spaghetti, null)),
                new Recipe(
                        "Chocolate Cake",
                        "In a large bowl, stir together the sugar, flour, cocoa, baking powder, baking soda and salt. Add the eggs, milk, oil and vanilla, mix for 2 minutes on medium speed of mixer. Stir in the boiling water last. Batter will be thin. Pour evenly into the prepared pans.",
                        ResourcesCompat.getDrawable(resources, R.drawable.chocolate, null)),
                new Recipe(
                        "Quiche",
                        ...
                        ResourcesCompat.getDrawable(resources, R.drawable.quiche, null)));
    }
}
